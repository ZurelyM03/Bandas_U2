function colorTest(a,b,c,d){
    ...
    mainColor.style="margin:10px;display: flex;justify-content: center;flex-wrap: wrap; background:#ffffff;border: 2px solid #ffffff;border-radius:22%;"; //solid #f4f0f0 es para el color del borde de la tira de colores, lo cambie de negro a blanco
    ...
    for(i=0;i<arreglo.length;i++){
      ...
      // Llama al  color que tienes en la funcion color
  ...
  colorTest(b1,b2,b3,b4);
    var valResistencia=b1*b3+(b2*(b3/10));
    var tolerancia=b4;
